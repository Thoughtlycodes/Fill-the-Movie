...
'moonlight','the social network','drive','the shape of water','inception','birdman',
'spotlight','ipman','hereditary','what we do in the shadows','whiplash','annihilation',
'the witch','lady brid','getout','boyhood','iron man','godzilla','hulk','the avengers',
'ice age','madmax','avatar','titanic','joker','black panther','jurassic world','frozen',
'shazam','incredibles','spider man','minions','aquaman','captain marvel','skyfall',
'transformers','avengers endgame','despicable me','jurassic park','finding dory',
...
'my dear kuttichathan', 'velipadinte pusthakam','you too brutus', 'neerali', 
'ittimani', 'pulimurugan', 'vismayam', 'drishyam', 'vadakkunokkiyanthram', 'nadodikkaattu']
...
{
    allArray = eng;
    document.getElementById('secondDiv').style.display = "unset";
